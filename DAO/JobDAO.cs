...
namespace ARMS.DAO
{
    class JobDAO
    {
        ...
        public RecipeParam parseMsg(PrimaryMessageWrapper pMsg)
        {
            ...
            String clusterRecipe = pMsg.Message.SecsItem.Items[1].Items[0].Items[2].GetValue<String>();
            ...
            foreach (Item item in items.Items)
            {
                if (item.Items[0] == "Frontside\\RecipeName")
                {
                    ...
                    frontsideReicpe = item.Items[1].Items[0].GetValue<String>();
            ...
            entity.ClusterRecipe = clusterRecipe;
            entity.FrontsideRecipe = frontsideReicpe;
            entity.InspectionDies = inspectionDies;
            entity.InspectionColumns = inspectionColumns;
            entity.InspectionRows = inspectionRows;
